...
conky.config = {
  ...
  -- colors
  default_color = '[=colors.panels.text]', -- regular text
  color1 = '[=colors.panels.labels]',
  color2 = '[=colors.panels.highlight]',        -- highlight important packages
...
${voffset 4}${lua_parse add_x_offset offset 5}${color1}title${lua_parse add_x_offset goto 50}${color}${scroll wait 20 4 1 ${cat /tmp/conky/musicplayer.track.title}}${lua decrease_total_lines 2}
${if_match "${lua get album ${cat /tmp/conky/musicplayer.track.album}}" != "unknown album"}\
${voffset 3}${lua_parse add_x_offset offset 5}${color1}album${lua_parse add_x_offset goto 50}${color}${scroll wait 20 4 1 ${lua get album}}${lua increment_offsets 0 16}${lua decrease_total_lines 1}
${endif}\
${if_match "${lua get artist ${cat /tmp/conky/musicplayer.track.artist}}" != "unknown artist"}\
${voffset 3}${lua_parse add_x_offset offset 5}${color1}artist${lua_parse add_x_offset goto 50}${color}${scroll wait 20 4 1 ${lua get artist}}${lua increment_offsets 0 16}${lua decrease_total_lines 1}
${endif}\
