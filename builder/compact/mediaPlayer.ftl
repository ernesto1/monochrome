...
${image ~/conky/monochrome/images/compact/[=image.primaryColor]-menu-top.png -p 0,[=y?c]}\
<#assign y += top>
...
${else}\
${image ~/conky/monochrome/images/compact/[=image.primaryColor]-menu-rhythmbox.png -p 0,[=top?c]}\
${endif}\
# :::: track details
<#assign y += bottom + space>
${image ~/conky/monochrome/images/compact/[=image.primaryColor]-menu-horizontal.png -p 0,[=y?c]}\
${image ~/conky/monochrome/images/compact/[=image.primaryColor]-menu-horizontal-data.png -p 45,[=y?c]}\
