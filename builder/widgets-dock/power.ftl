...
${voffset 4}${goto 67}${color}${font1}${battery_percent BAT0}${font0}%${font}${voffset 1}
${endif}\
${else}\
${if_match ${battery_percent BAT0} == 100}${image ~/conky/monochrome/images/widgets-dock/text-box-100.png -p 117,24}${endif}\
