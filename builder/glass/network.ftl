...
${voffset -9}${alignr 6}${color}${font2}${wireless_link_qual_perc [=device.name]}${font3}%
${voffset -2}${offset 16}${color2}${if_match ${wireless_link_qual_perc [=device.name]} < 30}${color3}${endif}${wireless_link_bar 3,93 [=device.name]}
${voffset -4}${offset 5}${color}${font}ch. ${wireless_channel [=device.name]}${alignr 6}${wireless_bitrate [=device.name]}
<#else>
# :::::: ethernet
