...
conky.text = [[
<#-- TODO lua panel function should account for panels wider than the image width, ie. remove this image variable hard coding -->
${image ~/conky/monochrome/images/common/grape-panel-light.png -p 219,0}\
${image ~/conky/monochrome/images/common/blank-panel.png -p 219,23}\
